...
$pdo = conectar();
        ...
        $increment_produtos_tamanhos = $pdo->exec("ALTER TABLE produtos_tamanhos CHANGE id id INT(11) NOT NULL AUTO_INCREMENT");
        $increment_produto_cores = $pdo->exec("ALTER TABLE produtos_cores CHANGE id id INT(11) NOT NULL AUTO_INCREMENT");
        $incremente_cores = $pdo->exec("ALTER TABLE cores CHANGE id id INT(11) NOT NULL AUTO_INCREMENT");
        $incremente_tamanhos = $pdo->exec("ALTER TABLE tamanhos CHANGE id id INT(11) NOT NULL AUTO_INCREMENT");
        $increment_produtos = $pdo->exec("ALTER TABLE produtos CHANGE id id INT(11) NOT NULL AUTO_INCREMENT");
